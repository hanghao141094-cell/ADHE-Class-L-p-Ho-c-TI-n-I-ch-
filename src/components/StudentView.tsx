  ...
  const handleSubmitAssignment = () => {
    ...
    solvingAssignment.questions.forEach(q => {
      ...
      if (q.type === 'single_choice') {
        ...
        if ((textAns && textAns.trim().length > 0) || imgAns.length > 0) {
          correctCount++;
        }
      }
    });
        ...
        {solvingAssignment && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full p-4 md:p-6 border-4 border-sky-400 space-y-5 my-8 text-left"
            >
